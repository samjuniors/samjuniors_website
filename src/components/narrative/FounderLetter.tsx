  ...
  return (
    <section className={styles.letterSection} aria-labelledby="founder-perspective-title">
      ...
      <p id="founder-perspective-title" className={styles.letterBody}>
        &ldquo;We created {companyContent.name} because we believe technology should be an <em>extension of human mastery</em>, not a substitute for it. The tools we build are meant to disappear into your hands — fast, dependable, and sovereign.&rdquo;
      </p>
      <div className={styles.signatureBlock}>
        <div>
          <div className={styles.signerName}>Founder & Engineering Leadership</div>
