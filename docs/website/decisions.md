...
10. **TODO — Cinematic experience implementation (gated)**: The 5-scene executable experience is fully specified and founder-ratified ([ADR-001](adr/ADR-001-homepage-experience-reconciliation.md); spec: [design-system.md §6.8](design-system.md#68-motion--micro-interactions); primitives: [component-inventory.md §4.10–§4.12](component-inventory.md#410-reveal-specified-adr-001); QA gates: [qa-checklist.md §2.10](qa-checklist.md#210-motion--interaction-safety-adr-001-implementation-gates)). **Production UI implementation awaits explicit founder approval** (ADR-001 §8), then proceeds vertical-slice-first ([delivery.md §2](delivery.md#2-vertical-slice-validation-mandatory-quality-gate)). Debt D11 (workbench mobile parity + touch targets) resolves inside that pass.
